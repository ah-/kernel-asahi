...
Source0: linux-5.16.0-0.rc5.6.test.tar.xz
...
%setup -q -n kernel-5.16.0-0.rc5.6.test -c
mv linux-5.16.0-0.rc5.6.test linux-%{KVERREL}
...
#
%changelog
* Tue Mar 29 2022 Prarit Bhargava <prarit@redhat.com> [5.16.0-0.rc5.6.test]
- v5.16-rc5 rebase
